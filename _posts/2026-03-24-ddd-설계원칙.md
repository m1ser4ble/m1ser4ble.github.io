...
categories: backend
excerpt: "DDD, Domain-Driven Design, Bounded Context, Ubiquitous Language, Aggregate, Aggregate Root, Entity, Value O..."
toc: true
toc_sticky: true
tags: [backend, ddd]
source: "/home/dwkim/dwkim/docs/backend/ddd-설계원칙.md"
---
TL;DR
...
- DDD 설계 원칙를 알아두면 설계 판단과 구현 선택을 더 분명하게 할 수 있다.
...
## 2. 배경
DDD 설계 원칙가 등장한 배경과 문제 상황을 이해하는 데 도움이 된다.

## 3. 이유
DDD 설계 원칙를 알아두면 설계 판단과 구현 선택을 더 분명하게 할 수 있다.

## 4. 특징
DDD 설계 원칙의 특징, 장단점, 적용 포인트를 원문에서 자세히 확인할 수 있다.

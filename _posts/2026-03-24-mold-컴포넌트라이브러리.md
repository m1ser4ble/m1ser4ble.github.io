...
categories: frontend
excerpt: "원재료 (Carbon, Ant Design)"
toc: true
toc_sticky: true
tags: [frontend, mold, 컴포넌트, 라이브러리, internal]
source: "/home/dwkim/dwkim/docs/frontend/mold-컴포넌트라이브러리.md"
---
TL;DR
- Mold 컴포넌트 라이브러리 (사내 디자인 시스템)의 핵심 개념을 빠르게 파악할 수 있다.
- 배경과 이유를 통해 왜 필요한지 맥락을 이해할 수 있다.
- 특징과 상세 내용을 통해 실무 적용 포인트를 확인할 수 있다.

## 1. 개념
Mold 컴포넌트 라이브러리 (사내 디자인 시스템)의 핵심 정의와 문제 공간을 간단히 정리한다.

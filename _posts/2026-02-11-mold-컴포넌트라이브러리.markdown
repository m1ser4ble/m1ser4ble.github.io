...
categories: frontend
excerpt: "Mold 컴포넌트 라이브러리 (사내 디자인 시스템)은/는 > 작성일: 2026-01-30"
toc: true
toc_sticky: true
tags: [Mold, 컴포넌트, 라이브러리, 사내, 자체, 디자인]
---

# TL;DR
- **Mold 컴포넌트 라이브러리 (사내 디자인 시스템)의 핵심 개념과 사용 범위를 한눈에 정리**
...
## 2. 배경
Mold 컴포넌트 라이브러리 (사내 디자인 시스템)이(가) 등장한 배경과 기존 한계를 정리한다.

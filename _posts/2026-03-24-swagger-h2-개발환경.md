...
categories: backend
excerpt: "Swagger = API 문서화 + 테스트 도구 (현재 OpenAPI)"
toc: true
toc_sticky: true
tags: [backend, swagger와, h2, 개발, 환경]
source: "/home/dwkim/dwkim/docs/backend/swagger-h2-개발환경.md"
---
TL;DR
- Swagger와 H2 - 개발 환경 도구의 핵심 개념을 빠르게 파악할 수 있다.
- 배경과 이유를 통해 왜 필요한지 맥락을 이해할 수 있다.
- 특징과 상세 내용을 통해 실무 적용 포인트를 확인할 수 있다.

## 1. 개념
Swagger와 H2 - 개발 환경 도구의 핵심 정의와 문제 공간을 간단히 정리한다.

...
categories: backend
excerpt: "어노테이션 용도 위치 @Tag 컨트롤러 그룹 이름 클래스 @Operation API 설명 메서드 @Parameter 파라미터 설명 파라미터 @Schema 모델/필드 설명 DTO 클래스/필드 @..."
toc: true
toc_sticky: true
tags: [backend, swagger, h2]
source: "/home/dwkim/dwkim/docs/backend/swagger-h2-개발환경.md"
---
TL;DR
- 어노테이션 용도 위치 @Tag 컨트롤러 그룹 이름 클래스 @Operation API 설명 메서드 @Parameter 파라미터 설명 파라미터 @Schema 모델/필드 설명 DTO 클래스/필드 @ApiResponse 응답 설명 메서드 @Hidden 문서에서 숨김 클래스/메서드 Swagger, OpenAPI, Springdoc, API 문서, H2, 인메모리 DB, 개발 환경, Spring Boot, DevTools

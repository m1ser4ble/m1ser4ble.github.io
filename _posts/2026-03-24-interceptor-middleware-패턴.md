...
categories: backend
excerpt: "Interceptor/Middleware 패턴의 핵심 개념과 실무 적용 포인트를 함께 정리한 글이다."
toc: true
toc_sticky: true
tags: [backend, interceptor, middleware]
source: "/home/dwkim/dwkim/docs/backend/interceptor-middleware-패턴.md"
---
TL;DR
- Interceptor/Middleware 패턴의 핵심 개념과 실무 적용 포인트를 함께 정리한 글이다.
- Interceptor/Middleware 패턴를 알아두면 설계 판단과 구현 선택을 더 분명하게 할 수 있다.
...
## 2. 배경
Interceptor/Middleware 패턴가 등장한 배경과 문제 상황을 이해하는 데 도움이 된다.

## 3. 이유
Interceptor/Middleware 패턴를 알아두면 설계 판단과 구현 선택을 더 분명하게 할 수 있다.

## 4. 특징
Interceptor/Middleware 패턴의 특징, 장단점, 적용 포인트를 원문에서 자세히 확인할 수 있다.

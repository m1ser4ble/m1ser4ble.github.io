...
categories: backend
excerpt: "JPA는 Java 객체를 관계형 데이터베이스에 매핑하기 위한 **표준 명세(Specification)**입니다."
toc: true
toc_sticky: true
tags: [backend, jpa, 핵심, 어노테이션, 완벽]
source: "/home/dwkim/dwkim/docs/backend/jpa-어노테이션.md"
---
TL;DR
- JPA 핵심 어노테이션 완벽 가이드의 핵심 개념을 빠르게 파악할 수 있다.
- 배경과 이유를 통해 왜 필요한지 맥락을 이해할 수 있다.
- 특징과 상세 내용을 통해 실무 적용 포인트를 확인할 수 있다.

## 1. 개념
JPA 핵심 어노테이션 완벽 가이드의 핵심 정의와 문제 공간을 간단히 정리한다.
...
### 2.4 사내 프로젝트의 MothershipBaseEntity 패턴

```kotlin
/**
 * 사내 Mothership 프로젝트의 표준 Base Entity
 */
@MappedSuperclass

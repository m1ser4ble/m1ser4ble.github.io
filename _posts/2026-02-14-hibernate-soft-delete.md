...
categories: backend
excerpt: "Hibernate와 Soft Delete은(는) 핵심 개념과 배경, 이유를 정리해 적용 기준을 제공한다."
toc: true
toc_sticky: true
tags: [hibernate, orm, jpa, softdelete, harddelete]
---
...
### 3.3 사내 프로젝트의 Soft Delete 패턴

사내 Mothership 프로젝트에서 실제 사용하는 패턴입니다.

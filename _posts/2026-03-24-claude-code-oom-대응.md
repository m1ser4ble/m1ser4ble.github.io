...
categories: devops
excerpt: "Claude Code 사용 중 SSH 연결 끊김"
toc: true
toc_sticky: true
tags: [devops, claude, code, oom, out]
source: "/home/dwkim/dwkim/docs/devops/claude-code-oom-대응.md"
---
TL;DR
- Claude Code OOM (Out of Memory) 대응의 핵심 개념을 빠르게 파악할 수 있다.
- 배경과 이유를 통해 왜 필요한지 맥락을 이해할 수 있다.
- 특징과 상세 내용을 통해 실무 적용 포인트를 확인할 수 있다.

## 1. 개념
Claude Code OOM (Out of Memory) 대응의 핵심 정의와 문제 공간을 간단히 정리한다.

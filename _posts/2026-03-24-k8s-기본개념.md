...
categories: infra
excerpt: "구성요소 역할 API Server 모든 요청의 진입점, REST API 제공 etcd 클러스터 상태 저장소 (Key-Value) Scheduler Pod를 어떤 Node에 배치할지 결정 Con..."
toc: true
toc_sticky: true
tags: [infra, k8s, kubernetes]
source: "/home/dwkim/dwkim/docs/infra/k8s-기본개념.md"
---
TL;DR

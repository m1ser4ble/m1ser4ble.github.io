...
categories: cloud
excerpt: "MinIO는 S3 API 호환 오브젝트 스토리지로 온프레미스와 로컬 개발 환경에서 데이터 저장을 일관된 방식으로 운영할 수 있게 해준다."
toc: true
toc_sticky: true
tags: [cloud, minio, s3, objectstorage, presignedurl, erasurecoding]
source: "/home/dwkim/dwkim/docs/cloud/minio-S3호환-오브젝트스토리지.md"
---
TL;DR

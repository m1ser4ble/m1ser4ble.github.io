...
categories: backend
excerpt: "companion object, Kotlin, static, 싱글톤, 팩토리 패턴, @JvmStatic, @JvmField, 객체지향"
toc: true
toc_sticky: true
tags: [backend, kotlin, companion, object]
source: "/home/dwkim/dwkim/docs/backend/kotlin-companion-object.md"
---
TL;DR
- companion object, Kotlin, static, 싱글톤, 팩토리 패턴, @JvmStatic, @JvmField, 객체지향
- Kotlin companion object를 알아두면 설계 판단과 구현 선택을 더 분명하게 할 수 있다.
...
## 2. 배경
Kotlin companion object가 등장한 배경과 문제 상황을 이해하는 데 도움이 된다.

## 3. 이유
Kotlin companion object를 알아두면 설계 판단과 구현 선택을 더 분명하게 할 수 있다.

## 4. 특징
Kotlin companion object의 특징, 장단점, 적용 포인트를 원문에서 자세히 확인할 수 있다.

...
categories: backend
excerpt: "Backend 기본 개념은 POJO·DTO·SSE·JPA/ORM·헥사고날 아키텍처·DI/DIP·JWT·CORS를 통해 서버 설계의 핵심 경계를 빠르게 이해하게 해주는 입문 정리다."
toc: true
toc_sticky: true
tags: [backend, architecture, pojo, dto, jpa, cors]

...
categories: frontend
excerpt: "Colocation, __tests__, .test.ts, .spec.ts, Jest, Vitest, Playwright, Cypress, E2E Test, Unit Test, Integrat..."
toc: true
toc_sticky: true
tags: [frontend, guide]
source: "/home/dwkim/dwkim/docs/frontend/테스트-디렉토리구조.md"
---
TL;DR
- Colocation, __tests__, .test.ts, .spec.ts, Jest, Vitest, Playwright, Cypress, E2E Test, Unit Test, Integration Test, Visual Test, Kent C.
- 프론트엔드 테스트 디렉토리 구조 - 최적의 테스트 파일 배치 전략를 알아두면 설계 판단과 구현 선택을 더 분명하게 할 수 있다.
...
## 2. 배경
프론트엔드 테스트 디렉토리 구조 - 최적의 테스트 파일 배치 전략가 등장한 배경과 문제 상황을 이해하는 데 도움이 된다.

## 3. 이유
프론트엔드 테스트 디렉토리 구조 - 최적의 테스트 파일 배치 전략를 알아두면 설계 판단과 구현 선택을 더 분명하게 할 수 있다.

## 4. 특징
프론트엔드 테스트 디렉토리 구조 - 최적의 테스트 파일 배치 전략의 특징, 장단점, 적용 포인트를 원문에서 자세히 확인할 수 있다.

...
categories: backend
excerpt: "2. [User Story 심층 분석](#2-user-story-심층-분석)"
toc: true
toc_sticky: true
tags: [backend, user, story, vs, use]
source: "/home/dwkim/dwkim/docs/pm/user-story-vs-use-case-vs-scenario-완전가이드.md"
---
TL;DR
- User Story vs Use Case vs Scenario 완전가이드의 핵심 개념을 빠르게 파악할 수 있다.
- 배경과 이유를 통해 왜 필요한지 맥락을 이해할 수 있다.
- 특징과 상세 내용을 통해 실무 적용 포인트를 확인할 수 있다.

## 1. 개념
User Story vs Use Case vs Scenario 완전가이드의 핵심 정의와 문제 공간을 간단히 정리한다.
...
User Story는 하나의 발명이 아니라, 여러 실무자의 기여가 축적된 결과물이다.

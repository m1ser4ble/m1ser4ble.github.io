...
categories: frontend
excerpt: "\"ASCII Art\"는 기술적으로 부정확한 표현이다"
toc: true
toc_sticky: true
tags: [frontend, box, drawing, characters와, cjk]
source: "/home/dwkim/dwkim/docs/frontend/box-drawing-cjk-렌더링.md"
---
TL;DR
- Box-Drawing Characters와 CJK 모노스페이스 렌더링의 핵심 개념을 빠르게 파악할 수 있다.
- 배경과 이유를 통해 왜 필요한지 맥락을 이해할 수 있다.
- 특징과 상세 내용을 통해 실무 적용 포인트를 확인할 수 있다.

## 1. 개념
Box-Drawing Characters와 CJK 모노스페이스 렌더링의 핵심 정의와 문제 공간을 간단히 정리한다.

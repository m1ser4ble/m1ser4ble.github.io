...
categories: cloud
excerpt: "Service Mesh = 마이크로서비스 간 통신을 관리하는 인프라 계층"
toc: true
toc_sticky: true
tags: [cloud, istio와, service, mesh]
source: "/home/dwkim/dwkim/docs/cloud/istio-서비스메시.md"
---
TL;DR
- Istio와 Service Mesh의 핵심 개념을 빠르게 파악할 수 있다.
- 배경과 이유를 통해 왜 필요한지 맥락을 이해할 수 있다.
- 특징과 상세 내용을 통해 실무 적용 포인트를 확인할 수 있다.

## 1. 개념
Istio와 Service Mesh의 핵심 정의와 문제 공간을 간단히 정리한다.

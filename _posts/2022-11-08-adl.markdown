...
categories: cpp
excerpt: "C++에서 friend, member pointer, ADL을 이용한 private 멤버 접근 기법"
toc: true
toc_sticky: true
tags: cpp
---
...
- [Stack Overflow - Access Private Member Using Template Trick](https://stackoverflow.com/questions/12993219/access-private-member-using-template-trick)
- [bloglitb - Access to Private Members](https://bloglitb.blogspot.com/2011/12/access-to-private-members-safer.html)

...
categories: ["Backend", "Authentication", "OAuth", "Social Login", "System Architecture"]
tags: ["SSO", "OAuth 2.0", "OAuth 2.1", "OIDC", "OpenID Connect", "Kakao Login", "Google Sign-In", "Naver Login", "Apple Sign In", "Authorization Code", "PKCE", "JWT"]
excerpt: "SSO 소셜 로그인 시스템 구축 가이드 문서를 Jekyll 포스트 형식으로 정리했습니다."

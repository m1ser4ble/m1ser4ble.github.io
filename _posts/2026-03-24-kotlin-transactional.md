...
categories: backend
excerpt: "@Transactional, Spring, Kotlin, AOP, 프록시, ACID, Propagation, Isolation, 롤백, JPA"
toc: true
toc_sticky: true
tags: [backend, kotlin, transactional]
...
- Kotlin @Transactional 어노테이션를 알아두면 설계 판단과 구현 선택을 더 분명하게 할 수 있다.
...
## 2. 배경
Kotlin @Transactional 어노테이션가 등장한 배경과 문제 상황을 이해하는 데 도움이 된다.

## 3. 이유
Kotlin @Transactional 어노테이션를 알아두면 설계 판단과 구현 선택을 더 분명하게 할 수 있다.

## 4. 특징
Kotlin @Transactional 어노테이션의 특징, 장단점, 적용 포인트를 원문에서 자세히 확인할 수 있다.

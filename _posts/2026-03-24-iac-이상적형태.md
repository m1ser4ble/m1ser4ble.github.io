...
categories: infra
excerpt: "Infrastructure as Code (IaC)"
toc: true
toc_sticky: true
tags: [infra, infrastructure, as, code, iac]
source: "/home/dwkim/dwkim/docs/infra/iac-이상적형태.md"
---
TL;DR
- Infrastructure as Code (IaC) - 이상적 형태와 핵심 개념의 핵심 개념을 빠르게 파악할 수 있다.
- 배경과 이유를 통해 왜 필요한지 맥락을 이해할 수 있다.
- 특징과 상세 내용을 통해 실무 적용 포인트를 확인할 수 있다.

## 1. 개념
Infrastructure as Code (IaC) - 이상적 형태와 핵심 개념의 핵심 정의와 문제 공간을 간단히 정리한다.

...
categories: backend
excerpt: "dataclasses = Python 3.7+에서 기본 제공되는 데이터 클래스 데코레이터"
toc: true
toc_sticky: true
tags: [backend, python, 데이터, 클래스, 비교]
source: "/home/dwkim/dwkim/docs/backend/python-데이터클래스-비교.md"
---
TL;DR
- Python 데이터 클래스 비교의 핵심 개념을 빠르게 파악할 수 있다.
- 배경과 이유를 통해 왜 필요한지 맥락을 이해할 수 있다.
- 특징과 상세 내용을 통해 실무 적용 포인트를 확인할 수 있다.

## 1. 개념
Python 데이터 클래스 비교의 핵심 정의와 문제 공간을 간단히 정리한다.

...
categories: backend
excerpt: "Coroutine, launch, async, suspend, Continuation, @Async, Dispatcher, Stackless, 동시성, 비동기"
toc: true
toc_sticky: true
tags: [backend, kotlin, coroutine, async]
source: "/home/dwkim/dwkim/docs/backend/kotlin-coroutine-async.md"
---
TL;DR
- Coroutine, launch, async, suspend, Continuation, @Async, Dispatcher, Stackless, 동시성, 비동기
- Kotlin Coroutine과 @Async 비교를 알아두면 설계 판단과 구현 선택을 더 분명하게 할 수 있다.
...
## 2. 배경
Kotlin Coroutine과 @Async 비교가 등장한 배경과 문제 상황을 이해하는 데 도움이 된다.

## 3. 이유
Kotlin Coroutine과 @Async 비교를 알아두면 설계 판단과 구현 선택을 더 분명하게 할 수 있다.

## 4. 특징
Kotlin Coroutine과 @Async 비교의 특징, 장단점, 적용 포인트를 원문에서 자세히 확인할 수 있다.
